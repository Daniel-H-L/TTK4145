...
func main() {
	...
	chan_master_received_msg := make(chan Network.StandardData, 1)
	...
	for {
		...
		case 0:
			...
			Slave.Slave_init(BCAST_PORT, chan_error_slave, chan_change_to_master, &MasterIP, state, chan_new_network_order, chan_new_hw_order, chan_new_master_order, chan_order_executed, chan_set_lights, chan_network_lights, PORT, chan_source_ip, chan_descendant_nr, chan_new_network_order, chan_elev_state, chan_kill, chan_kill2)
